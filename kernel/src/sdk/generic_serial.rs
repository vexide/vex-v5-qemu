...
pub extern "C" fn vexDeviceGenericSerialTransmit(device: V5_DeviceT, buffer: *const u8, length: i32) -> i32 {
    Default::default()
}
...
pub extern "C" fn vexDeviceGenericSerialReceive(device: V5_DeviceT, buffer: *mut u8, length: i32) -> i32 {
    Default::default()
}
